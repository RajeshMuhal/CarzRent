            ...
            <Col lg="3" md="4" sm="6">
              <div className="mb-4">
                ...
                <p className="head__office">
                  123, Fancy Bazar,Guwahati
                </p>
                <p className="head__office">Phone: +91 9876543210 </p>
                <p className="head__office">Email: rentcar@gmail.com</p>
                <p className="head__office">Office Time: 9am - 8pm</p>
              </div>
            </Col>
            ...
            <Col>
              <div className="footer__bottom">
                <p className="section__description pt-4 fw-bold text-center d-flex align-items-center justify-content-center gap-1">
                  ...
                  <span>Rajesh Muhal</span>. All Rights Reserved
                </p>
              </div>
            </Col>
          </Row>
